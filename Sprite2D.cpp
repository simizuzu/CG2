...
void Sprite2D::CreatConstBuff()
{
	...
	DX12Math::MakeOrthogonalL(0.0f, width, height, 0.0f, 0.0f, 1.0f, matProjection);
}
...
void Sprite2D::Update(const DX12Math::Vector3& pos, const DX12Math::Vector3& rot, const DX12Math::Vector3& scale, const DX12Math::Vector4& color)
{
	//カラー
	for (int i = 0; i < 4; i++)
	{

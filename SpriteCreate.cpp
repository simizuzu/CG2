...
ModelShareVaria SpriteCreate::modelShareVaria{};

SpriteInterface* SpriteCreate::CreateSprite(const wchar_t* filePath, bool flag3d)
{
	...
	if (flag3d)
	{
		...
		SpriteInterface* s3D = new Sprite3D;
	...
	{
		SpriteInterface* s2D = new Sprite2D;
...
void SpriteCreat::CreatPipeline()
{
	HRESULT result;
	...
	result = D3DCompileFromFile(
		L"Resources/Shaders/2D/SpriteVS.hlsl", // シェーダファイル名
		nullptr,
	...
	// ピクセルシェーダの読み込みとコンパイル
	result = D3DCompileFromFile(
		L"Resources/Shaders/2D/SpritePS.hlsl", // シェーダファイル名
		nullptr,
		D3D_COMPILE_STANDARD_FILE_INCLUDE, // インクルード可能にする
...
void SpriteCreat::CreateDescriptorHeap()
{
	HRESULT result;
	Microsoft::WRL::ComPtr<ID3D12Device> device = DirectX12Core::GetInstance()->GetDevice();
	//SRVの最大個数
...
void SpriteCreat::CreateDescriptorRange()
{
